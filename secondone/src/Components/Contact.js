    ...
    <section className="contact" id="connect">
      <Container>
        <Row className="align-items-center">
          <Col size={24} md={6} sm={3}>
            <TrackVisibility>
              {({ isVisible }) =>
                <img className={isVisible ? "animate__animated animate__zoomIn" : ""} src={QRIMG} alt="SCAN ME"/>
              }
            </TrackVisibility>
          </Col>
          <Col size={12} md={6}>
              ...
              {({ isVisible }) =>
                ...
                <form onSubmit={handleSubmit}>
                  <Row>
                    ...
                    <Col size={12} sm={6} className="px-1">
                      <input type="email" value={formDetails.email} placeholder=" Your Email Address" onChange={(e) => onFormUpdate('email', e.target.value)} />
                    </Col>
